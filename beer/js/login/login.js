/* user-passport/1.0.0 underscore-min.js Date:2017-07-04 18:02:54 */
(function() {
	function a(a) {
	...
	s.mixin = function(a) {
		...
		return "" + this._wrapped
	}, "function" == typeof define && define.amd && define("//misc.360buyimg.com/user/passport/1.0.0/js/underscore", [], function() {
		return s
	})
}).call(this);